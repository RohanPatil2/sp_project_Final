...
make clean
make
bin/server            # should print the new "Loaded configuration" banner # in Terminal 1

# Terminal 2
curl http://localhost:8080/
curl http://localhost:8080/cgi-bin/GET.cgi

You can load the link in browser as well
